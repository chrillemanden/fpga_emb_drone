...
/* Definitions for peripheral PS_BRAM_AXI_BRAM_CTRL_0 */
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_DEVICE_ID 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_DATA_WIDTH 32U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_ECC 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_FAULT_INJECT 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_CE_FAILING_REGISTERS 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_UE_FAILING_REGISTERS 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_ECC_STATUS_REGISTERS 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_CE_COUNTER_WIDTH 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_ECC_ONOFF_REGISTER 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_ECC_ONOFF_RESET_VALUE 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_WRITE_ACCESS 0U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_S_AXI_BASEADDR 0x40000000U
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_S_AXI_HIGHADDR 0x40001FFFU
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_S_AXI_CTRL_BASEADDR 0xFFFFFFFFU  
#define XPAR_PS_BRAM_AXI_BRAM_CTRL_0_S_AXI_CTRL_HIGHADDR 0xFFFFFFFFU  


/******************************************************************/

/* Canonical definitions for peripheral PS_BRAM_AXI_BRAM_CTRL_0 */
#define XPAR_BRAM_0_DEVICE_ID XPAR_PS_BRAM_AXI_BRAM_CTRL_0_DEVICE_ID
