...
# module references:
# Controller, clk_divider, spi_follower_receiver, spi_follower_transmitter
...
proc create_hier_cell_PS_BRAM { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PS_BRAM() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:bram_rtl:1.0 BRAM_PORTB_0
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins BRAM_PORTB_0] [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTB]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins PS_BRAM/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins PS_BRAM/FIXED_IO]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins Controller_0/rst] [get_bd_pins PS_BRAM/BRAM_PORTB_0_rst] [get_bd_pins clk_divider_0/rst] [get_bd_pins spi_follower_receiver_0/rst] [get_bd_pins spi_follower_transmi_0/rst]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces PS_BRAM/processing_system7_0/Data] [get_bd_addr_segs PS_BRAM/axi_bram_ctrl_0/S_AXI/Mem0] -force
