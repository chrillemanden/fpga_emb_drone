...
--               c:/Users/Bruger/Documents/fpga_emb_drone/FPGA_drone/FPGA_drone.srcs/sources_1/bd/design_1/ip/design_1_spi_follower_transmi_0_0/design_1_spi_follower_transmi_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_spi_follower_transmi_0_0_spi_follower_transmitter is
  ...
  signal \FSM_onehot_nextState_reg[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_nextState_reg[0]_i_1\ : label is "soft_lutpair1";
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_nextState_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \FSM_onehot_nextState_reg[1]_i_1\ : label is "soft_lutpair1";
...
\FSM_onehot_nextState_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F44"
    )
        port map (
...
\FSM_onehot_nextState_reg[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\FSM_onehot_nextState_reg[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\index[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
